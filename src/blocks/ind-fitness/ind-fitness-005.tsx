...
export default function IndFitness005(props: BlockProps) {
  const { theme, heading = "Fitness / Gym section", subheading = "Professional fitness / gym solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
