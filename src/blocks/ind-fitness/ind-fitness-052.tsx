...
export default function IndFitness052(props: BlockProps) {
  const { theme, heading = "Dark fitness / gym section", subheading = "Trusted fitness / gym platform", buttonText = "Get Started" } = props;
  return (
