...
export default function AnimMarquee004(props: BlockProps) {
  const { theme, heading = "Marquee / ticker", subheading = "Marquee / ticker", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
