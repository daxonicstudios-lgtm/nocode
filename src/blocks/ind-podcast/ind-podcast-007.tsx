...
export default function IndPodcast007(props: BlockProps) {
  const { theme, heading = "Podcast section", subheading = "Professional podcast solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
