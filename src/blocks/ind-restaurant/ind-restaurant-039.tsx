...
export default function IndRestaurant039(props: BlockProps) {
  const { theme, heading = "Restaurant section", subheading = "Professional restaurant solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
