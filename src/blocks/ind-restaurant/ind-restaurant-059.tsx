...
export default function IndRestaurant059(props: BlockProps) {
  const { theme, heading = "Dark restaurant section", subheading = "Trusted restaurant platform", buttonText = "Get Started" } = props;
  return (
