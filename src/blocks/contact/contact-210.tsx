...
export default function Contact210(props: BlockProps) {
  const { theme, heading = "Let's Talk", subheading = "We typically respond within 24 hours.", buttonText = "Send Message" } = props;
