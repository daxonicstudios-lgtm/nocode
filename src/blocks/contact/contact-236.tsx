...
export default function Contact236(props: BlockProps) {
  const { theme, heading = "Send Us a Message", subheading = "Our team is here to help.", buttonText = "Get in Touch" } = props;
