...
export default function Contact096(props: BlockProps) {
  const { theme, heading = "Contact Us", subheading = "We typically respond within 24 hours.", buttonText = "Send Message" } = props;
