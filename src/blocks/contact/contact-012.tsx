...
export default function Contact012(props: BlockProps) {
  const { theme, heading = "Send Us a Message", subheading = "We typically respond within 24 hours.", buttonText = "Send Message" } = props;
