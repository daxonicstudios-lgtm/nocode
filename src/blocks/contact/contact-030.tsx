...
export default function Contact030(props: BlockProps) {
  const { theme, heading = "We'd Love to Hear From You", subheading = "We typically respond within 24 hours.", buttonText = "Send Message" } = props;
