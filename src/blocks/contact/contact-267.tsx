...
export default function Contact267(props: BlockProps) {
  const { theme, heading = "Reach Out", subheading = "We typically respond within 24 hours.", buttonText = "Send Message" } = props;
