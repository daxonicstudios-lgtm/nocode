...
export default function Contact025(props: BlockProps) {
  const { theme, heading = "Get in Touch", subheading = "Fill out the form and we'll get back to you.", buttonText = "Send" } = props;
