...
export default function Contact047(props: BlockProps) {
  const { theme, heading = "Drop Us a Line", subheading = "Our team is here to help.", buttonText = "Get in Touch" } = props;
