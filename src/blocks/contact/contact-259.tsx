...
export default function Contact259(props: BlockProps) {
  const { theme, heading = "Reach Out", subheading = "Fill out the form and we'll get back to you.", buttonText = "Send" } = props;
