...
export default function Contact253(props: BlockProps) {
  const { theme, heading = "Have Questions?", subheading = "Fill out the form and we'll get back to you.", buttonText = "Send" } = props;
