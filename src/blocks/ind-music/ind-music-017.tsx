...
export default function IndMusic017(props: BlockProps) {
  const { theme, heading = "Music section", subheading = "Professional music solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
