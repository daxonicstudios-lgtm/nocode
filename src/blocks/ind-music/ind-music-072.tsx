...
export default function IndMusic072(props: BlockProps) {
  const { theme, heading = "Dark music section", subheading = "Trusted music platform", buttonText = "Get Started" } = props;
  return (
