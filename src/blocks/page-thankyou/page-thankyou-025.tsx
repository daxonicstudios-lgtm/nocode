...
export default function PageThankyou025(props: BlockProps) {
  const { theme, heading = "Thank you page", subheading = "Thank you page", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
