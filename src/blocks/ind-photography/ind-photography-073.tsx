...
export default function IndPhotography073(props: BlockProps) {
  const { theme, heading = "Dark photography section", subheading = "Trusted photography platform", buttonText = "Get Started" } = props;
  return (
