...
export default function IndEducation021(props: BlockProps) {
  const { theme, heading = "Education section", subheading = "Professional education solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
