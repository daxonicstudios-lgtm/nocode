...
export default function IndEducation056(props: BlockProps) {
  const { theme, heading = "Dark education section", subheading = "Trusted education platform", buttonText = "Get Started" } = props;
  return (
