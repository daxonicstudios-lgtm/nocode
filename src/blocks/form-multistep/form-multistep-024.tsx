...
export default function FormMultistep024(props: BlockProps) {
  const { theme, heading = "Multi-step wizard form", subheading = "Multi-step wizard form", buttonText = "Submit" } = props;
