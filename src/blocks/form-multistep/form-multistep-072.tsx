...
export default function FormMultistep072(props: BlockProps) {
  const { theme, heading = "Dark multi-step wizard form", subheading = "Multi-step wizard form", buttonText = "Submit" } = props;
