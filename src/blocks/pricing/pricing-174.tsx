...
export default function Pricing174(props: BlockProps) {
  const { theme, heading = "Budget-Friendly Plans", subheading = "Scale at your own pace", items = DEFAULT_ITEMS } = props;
