...
export default function Pricing239(props: BlockProps) {
  const { theme, heading = "Cost-Effective Solutions", subheading = "One straightforward plan with everything you need.", buttonText = "Start Now", items = DEFAULT_ITEMS } = props;
