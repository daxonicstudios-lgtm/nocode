...
export default function Pricing131(props: BlockProps) {
  const { theme, heading = "Your Perfect Plan", subheading = "Beautiful plans for beautiful projects", items = DEFAULT_ITEMS } = props;
