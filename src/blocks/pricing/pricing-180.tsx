...
export default function Pricing180(props: BlockProps) {
  const { theme, heading = "Choose Your Plan", subheading = "Powerful features at every level", buttonText = "Choose Plan", items = DEFAULT_ITEMS } = props;
