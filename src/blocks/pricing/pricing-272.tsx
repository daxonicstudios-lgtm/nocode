...
export default function Pricing272(props: BlockProps) {
  const { theme, heading = "Pricing Options", subheading = "One straightforward plan with everything you need.", buttonText = "Start Now", items = DEFAULT_ITEMS } = props;
