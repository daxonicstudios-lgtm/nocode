...
export default function Pricing048(props: BlockProps) {
  const { theme, heading = "Select a Plan", subheading = "Powerful features at every level", buttonText = "Choose Plan", items = DEFAULT_ITEMS } = props;
