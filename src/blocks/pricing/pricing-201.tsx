...
export default function Pricing201(props: BlockProps) {
  const { theme, heading = "Flexible Pricing", subheading = "Powerful features at every level", buttonText = "Choose Plan", items = DEFAULT_ITEMS } = props;
