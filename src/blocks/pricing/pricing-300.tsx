...
export default function Pricing300(props: BlockProps) {
  const { theme, heading = "Choose Your Plan", subheading = "One straightforward plan with everything you need.", buttonText = "Start Now", items = DEFAULT_ITEMS } = props;
