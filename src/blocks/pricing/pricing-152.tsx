...
export default function Pricing152(props: BlockProps) {
  const { theme, heading = "Pricing Options", subheading = "Beautiful plans for beautiful projects", items = DEFAULT_ITEMS } = props;
