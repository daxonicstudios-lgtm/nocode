...
export default function Pricing233(props: BlockProps) {
  const { theme, heading = "Smart Pricing", subheading = "Beautiful plans for beautiful projects", items = DEFAULT_ITEMS } = props;
