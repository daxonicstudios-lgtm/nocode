...
export default function Pricing078(props: BlockProps) {
  const { theme, heading = "Subscription Plans", subheading = "Beautiful plans for beautiful projects", items = DEFAULT_ITEMS } = props;
