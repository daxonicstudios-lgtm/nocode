...
export default function Pricing294(props: BlockProps) {
  const { theme, heading = "Budget-Friendly Plans", subheading = "Beautiful plans for beautiful projects", items = DEFAULT_ITEMS } = props;
