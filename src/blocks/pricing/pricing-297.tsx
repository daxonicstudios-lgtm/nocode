...
export default function Pricing297(props: BlockProps) {
  const { theme, heading = "Ecommerce Pricing", subheading = "Professional plans tailored for ecommerce", buttonText = "Get Started", items = DEFAULT_ITEMS } = props;
