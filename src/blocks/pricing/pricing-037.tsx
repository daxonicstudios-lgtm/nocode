...
const DEFAULT_ITEMS = [
  { title: "Basic Cut", value: "$25", description: "Starting from", items: "Core service,Basic support,Standard scheduling" },
  { title: "Premium Package", value: "$65", description: "Most popular", items: "Full service,Priority booking,Dedicated specialist,Follow-up included,Member perks" },
  { title: "VIP Experience", value: "$120", description: "Ultimate experience", items: "All services,VIP access,Personal consultant,Exclusive perks,Priority support,Premium extras,Loyalty rewards" },
];

export default function Pricing037(props: BlockProps) {
  const { theme, heading = "Salon Pricing", subheading = "Professional salon services at competitive rates", buttonText = "Book Now", items = DEFAULT_ITEMS } = props;

  return (
    <section style={{ backgroundColor: theme?.background, color: theme?.foreground }} className="px-4 py-20">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <Scissors className="w-8 h-8 mx-auto mb-3" style={{ color: theme?.primary }} />
