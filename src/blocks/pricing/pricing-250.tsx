...
export default function Pricing250(props: BlockProps) {
  const { theme, heading = "Value-Driven Pricing", subheading = "Scale at your own pace", items = DEFAULT_ITEMS } = props;
