...
export default function Pricing137(props: BlockProps) {
  const { theme, heading = "Investment Plans", subheading = "One straightforward plan with everything you need.", buttonText = "Start Now", items = DEFAULT_ITEMS } = props;
