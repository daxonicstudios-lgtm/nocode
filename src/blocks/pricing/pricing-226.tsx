...
export default function Pricing226(props: BlockProps) {
  const { theme, heading = "Get Started Today", subheading = "Beautiful plans for beautiful projects", items = DEFAULT_ITEMS } = props;
