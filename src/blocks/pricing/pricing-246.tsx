...
export default function Pricing246(props: BlockProps) {
  const { theme, heading = "Get Started Today", subheading = "One straightforward plan with everything you need.", buttonText = "Start Now", items = DEFAULT_ITEMS } = props;
