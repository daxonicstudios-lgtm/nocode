...
export default function Pricing184(props: BlockProps) {
  const { theme, heading = "Simple Pricing", subheading = "One straightforward plan with everything you need.", buttonText = "Start Now", items = DEFAULT_ITEMS } = props;
