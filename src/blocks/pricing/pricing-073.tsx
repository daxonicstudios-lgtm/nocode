...
export default function Pricing073(props: BlockProps) {
  const { theme, heading = "Smart Pricing", subheading = "Powerful features at every level", buttonText = "Choose Plan", items = DEFAULT_ITEMS } = props;
