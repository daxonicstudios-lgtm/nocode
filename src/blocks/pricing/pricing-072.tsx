...
const DEFAULT_ITEMS = [
  { title: "Free", value: "$5", description: "For individuals", items: "1 project,Basic support,1GB storage" },
  { title: "Plus", value: "$25", description: "For small teams", items: "10 projects,Priority support,50GB storage,Custom domain,Integrations" },
  { title: "Scale", value: "$59", description: "For organizations", items: "Unlimited projects,24/7 support,Unlimited storage,Custom domain,API access,SSO,Dedicated manager" },
];

export default function Pricing072(props: BlockProps) {
  const { theme, heading = "Pricing Options", subheading = "Trusted by thousands of businesses.", buttonText = "Get Started", items = DEFAULT_ITEMS } = props;
