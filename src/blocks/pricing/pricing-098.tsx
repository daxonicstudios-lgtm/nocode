...
export default function Pricing098(props: BlockProps) {
  const { theme, heading = "Subscription Plans", subheading = "One straightforward plan with everything you need.", buttonText = "Start Now", items = DEFAULT_ITEMS } = props;
