...
export default function Pricing249(props: BlockProps) {
  const { theme, heading = "Affordable Plans", subheading = "Powerful features at every level", buttonText = "Choose Plan", items = DEFAULT_ITEMS } = props;
