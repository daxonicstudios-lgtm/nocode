...
export default function PageOffline006(props: BlockProps) {
  const { theme, heading = "Offline fallback page", subheading = "Offline fallback page", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
