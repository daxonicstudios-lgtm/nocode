...
// Dashboard
import "./dash-layouts";
import "./dash-sidebars";
import "./dash-tables";
import "./dash-charts";
import "./dash-profiles";
import "./dash-settings";
import "./dash-notifications";
import "./dash-upload";
import "./dash-kanban";
import "./dash-calendar";
import "./dash-search";
import "./dash-empty";
import "./dash-onboarding";
import "./dash-chat";
import "./dash-activity";
import "./dash-tasks";
import "./dash-inbox";
import "./dash-user-mgmt";
import "./dash-billing";

// Industry-Specific
import "./ind-restaurant";
import "./ind-realestate";
import "./ind-medical";
import "./ind-education";
import "./ind-fitness";
import "./ind-legal";
import "./ind-automotive";
import "./ind-beauty";
import "./ind-construction";
import "./ind-church";
import "./ind-wedding";
import "./ind-photography";
import "./ind-music";
import "./ind-pets";
import "./ind-travel";
import "./ind-finance";
import "./ind-nonprofit";
import "./ind-coaching";
import "./ind-fashion";
import "./ind-agriculture";
import "./ind-interior";
import "./ind-architecture";
import "./ind-gaming";
import "./ind-podcast";
import "./ind-news";
