...
export default function AnimText006(props: BlockProps) {
  const { theme, heading = "Text animation", subheading = "Text animation", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
