...
export default function AnimScroll011(props: BlockProps) {
  const { theme, heading = "Scroll animation", subheading = "Scroll animation", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
