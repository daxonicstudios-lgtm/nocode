...
export default function IndHr060(props: BlockProps) {
  const { theme, heading = "Dark hr / recruitment section", subheading = "Trusted hr / recruitment platform", buttonText = "Get Started" } = props;
  return (
