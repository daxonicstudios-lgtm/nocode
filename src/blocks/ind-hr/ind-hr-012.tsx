...
export default function IndHr012(props: BlockProps) {
  const { theme, heading = "HR / Recruitment section", subheading = "Professional hr / recruitment solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
