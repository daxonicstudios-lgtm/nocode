...
export default function NavBreadcrumbs002(props: BlockProps) {
  const { theme, heading = "Breadcrumb navigation", subheading = "Breadcrumb navigation", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
