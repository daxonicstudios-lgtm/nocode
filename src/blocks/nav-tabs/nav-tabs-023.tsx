...
export default function NavTabs023(props: BlockProps) {
  const { theme, heading = "Tab navigation", subheading = "Tab navigation", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
