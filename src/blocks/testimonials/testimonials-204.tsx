...
export default function Testimonials204(props: BlockProps) {
  const { theme, heading = "Reviews", subheading = "Trusted by thousands worldwide.", items = DEFAULT_ITEMS } = props;
