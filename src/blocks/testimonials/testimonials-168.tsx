...
export default function Testimonials168(props: BlockProps) {
  const { theme, heading = "What Our Clients Say", subheading = "Trusted by thousands worldwide.", items = DEFAULT_ITEMS } = props;
