...
export default function Testimonials042(props: BlockProps) {
  const { theme, heading = "Customer Stories", subheading = "Trusted by thousands worldwide.", items = DEFAULT_ITEMS } = props;
