...
export default function Testimonials102(props: BlockProps) {
  const { theme, heading = "Client Feedback", subheading = "Trusted by thousands worldwide.", items = DEFAULT_ITEMS } = props;
