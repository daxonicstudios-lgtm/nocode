...
export default function Testimonials081(props: BlockProps) {
  const { theme, heading = "Testimonials", subheading = "Trusted by thousands worldwide.", items = DEFAULT_ITEMS } = props;
