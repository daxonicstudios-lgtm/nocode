...
export default function Testimonials291(props: BlockProps) {
  const { theme, heading = "Hear From Our Users", subheading = "Trusted by thousands worldwide.", items = DEFAULT_ITEMS } = props;
