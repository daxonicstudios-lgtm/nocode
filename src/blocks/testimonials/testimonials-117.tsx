...
export default function Testimonials117(props: BlockProps) {
  const { theme, heading = "Success Stories", subheading = "Trusted by thousands worldwide.", items = DEFAULT_ITEMS } = props;
