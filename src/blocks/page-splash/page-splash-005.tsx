...
export default function PageSplash005(props: BlockProps) {
  const { theme, heading = "Splash / intro page", subheading = "Splash / intro page", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
