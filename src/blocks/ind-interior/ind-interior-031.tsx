...
export default function IndInterior031(props: BlockProps) {
  const { theme, heading = "Dark interior design section", subheading = "Trusted interior design platform", buttonText = "Get Started" } = props;
  return (
