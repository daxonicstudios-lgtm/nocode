...
export default function IndInterior026(props: BlockProps) {
  const { theme, heading = "Interior Design section", subheading = "Professional interior design solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
