...
export default function IndCoaching002(props: BlockProps) {
  const { theme, heading = "Coaching / Consulting section", subheading = "Professional coaching / consulting solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
