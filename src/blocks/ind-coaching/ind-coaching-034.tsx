...
export default function IndCoaching034(props: BlockProps) {
  const { theme, heading = "Dark coaching / consulting section", subheading = "Trusted coaching / consulting platform", buttonText = "Get Started" } = props;
  return (
