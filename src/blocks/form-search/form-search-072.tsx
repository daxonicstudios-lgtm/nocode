...
export default function FormSearch072(props: BlockProps) {
  const { theme, heading = "Card-style search bar component", subheading = "Search bar component", buttonText = "Submit" } = props;
