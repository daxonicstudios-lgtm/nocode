...
export default function FormSearch026(props: BlockProps) {
  const { theme, heading = "Search bar component", subheading = "Search bar component", buttonText = "Submit" } = props;
