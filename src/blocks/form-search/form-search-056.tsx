...
export default function FormSearch056(props: BlockProps) {
  const { theme, heading = "Dark search bar component", subheading = "Search bar component", buttonText = "Submit" } = props;
