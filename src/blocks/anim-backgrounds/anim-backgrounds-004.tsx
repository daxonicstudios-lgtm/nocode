...
export default function AnimBackgrounds004(props: BlockProps) {
  const { theme, heading = "Animated background", subheading = "Animated background", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
