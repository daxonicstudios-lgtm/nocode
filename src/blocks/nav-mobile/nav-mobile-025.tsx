...
export default function NavMobile025(props: BlockProps) {
  const { theme, heading = "Mobile menu / drawer", subheading = "Mobile menu / drawer", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
