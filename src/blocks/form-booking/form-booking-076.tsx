...
export default function FormBooking076(props: BlockProps) {
  const { theme, heading = "Dark booking / appointment form", subheading = "Booking / appointment form", buttonText = "Submit" } = props;
