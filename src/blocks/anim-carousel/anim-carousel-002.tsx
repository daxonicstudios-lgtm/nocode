...
export default function AnimCarousel002(props: BlockProps) {
  const { theme, heading = "Carousel / slider", subheading = "Carousel / slider", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
