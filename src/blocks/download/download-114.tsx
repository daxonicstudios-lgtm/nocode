...
export default function Download114(props: BlockProps) {
  const { theme, heading = "Take It Anywhere", subheading = "Available on iOS and Android.", buttonText = "Download Now", buttonUrl = "#" } = props;
