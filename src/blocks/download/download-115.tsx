...
export default function Download115(props: BlockProps) {
  const { theme, heading = "Your Pocket Companion", subheading = "Download now and get started.", bodyText = "Available on iOS and Android. Free to download.", imageUrl } = props;
