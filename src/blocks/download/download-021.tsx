...
export default function Download021(props: BlockProps) {
  const { theme, heading = "Start on Mobile", subheading = "Available on iOS and Android.", buttonText = "Download Now", buttonUrl = "#" } = props;
