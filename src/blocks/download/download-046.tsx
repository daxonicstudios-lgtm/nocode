...
export default function Download046(props: BlockProps) {
  const { theme, heading = "Go Mobile", subheading = "Download now and get started.", bodyText = "Available on iOS and Android. Free to download.", imageUrl } = props;
