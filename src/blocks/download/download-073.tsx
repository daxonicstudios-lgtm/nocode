...
export default function Download073(props: BlockProps) {
  const { theme, heading = "Download Our App", subheading = "Download now and get started.", bodyText = "Available on iOS and Android. Free to download.", imageUrl } = props;
