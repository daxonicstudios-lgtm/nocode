...
export default function Download112(props: BlockProps) {
  const { theme, heading = "Get the App", subheading = "Download now and get started.", bodyText = "Available on iOS and Android. Free to download.", imageUrl } = props;
