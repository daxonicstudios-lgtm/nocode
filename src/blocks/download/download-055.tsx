...
export default function Download055(props: BlockProps) {
  const { theme, heading = "Free Download", subheading = "Download now and get started.", bodyText = "Available on iOS and Android. Free to download.", imageUrl } = props;
