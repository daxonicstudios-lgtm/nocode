...
export default function Download105(props: BlockProps) {
  const { theme, heading = "Download Our App", subheading = "Available on iOS and Android.", buttonText = "Download Now", buttonUrl = "#" } = props;
