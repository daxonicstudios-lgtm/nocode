...
export default function Download096(props: BlockProps) {
  const { theme, heading = "Get the App", subheading = "Available on iOS and Android.", buttonText = "Download Now", buttonUrl = "#" } = props;
