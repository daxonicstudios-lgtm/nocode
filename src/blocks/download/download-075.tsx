...
export default function Download075(props: BlockProps) {
  const { theme, heading = "Your Pocket Companion", subheading = "Available on iOS and Android.", buttonText = "Download Now", buttonUrl = "#" } = props;
