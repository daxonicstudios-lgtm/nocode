...
export default function Download124(props: BlockProps) {
  const { theme, heading = "Mobile App", subheading = "Download now and get started.", bodyText = "Available on iOS and Android. Free to download.", imageUrl } = props;
