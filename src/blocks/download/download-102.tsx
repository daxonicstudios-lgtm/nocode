...
export default function Download102(props: BlockProps) {
  const { theme, heading = "Go Mobile", subheading = "Available on iOS and Android.", buttonText = "Download Now", buttonUrl = "#" } = props;
