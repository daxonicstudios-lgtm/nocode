...
export default function IndNews026(props: BlockProps) {
  const { theme, heading = "News / Media section", subheading = "Professional news / media solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
