...
export default function IndNews056(props: BlockProps) {
  const { theme, heading = "Dark news / media section", subheading = "Trusted news / media platform", buttonText = "Get Started" } = props;
  return (
