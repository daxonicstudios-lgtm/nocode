...
export default function IndBeauty030(props: BlockProps) {
  const { theme, heading = "Beauty / Salon section", subheading = "Professional beauty / salon solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
