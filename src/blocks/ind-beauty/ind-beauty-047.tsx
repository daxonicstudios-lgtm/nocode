...
export default function IndBeauty047(props: BlockProps) {
  const { theme, heading = "Dark beauty / salon section", subheading = "Trusted beauty / salon platform", buttonText = "Get Started" } = props;
  return (
