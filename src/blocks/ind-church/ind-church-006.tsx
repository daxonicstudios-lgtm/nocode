...
export default function IndChurch006(props: BlockProps) {
  const { theme, heading = "Church / Religious section", subheading = "Professional church / religious solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
