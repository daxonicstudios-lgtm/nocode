...
export default function IndChurch041(props: BlockProps) {
  const { theme, heading = "Dark church / religious section", subheading = "Trusted church / religious platform", buttonText = "Get Started" } = props;
  return (
