...
export default function FormRegistration071(props: BlockProps) {
  const { theme, heading = "Dark event / course registration", subheading = "Event / course registration", buttonText = "Submit" } = props;
