...
export default function FormRegistration001(props: BlockProps) {
  const { theme, heading = "Event / course registration", subheading = "Event / course registration", buttonText = "Submit" } = props;
