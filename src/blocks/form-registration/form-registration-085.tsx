...
export default function FormRegistration085(props: BlockProps) {
  const { theme, heading = "Card-style event / course registration", subheading = "Event / course registration", buttonText = "Submit" } = props;
