...
export default function DashSidebars077(props: BlockProps) {
  const { theme, heading = "Dark dashboard sidebar navigation", subheading = "Dashboard sidebar navigation" } = props;
  return (
