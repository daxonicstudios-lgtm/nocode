...
export default function DashSidebars050(props: BlockProps) {
  const { theme, heading = "Dashboard sidebar navigation", subheading = "Dashboard sidebar navigation" } = props;
  return (
