...
export default function Faq200(props: BlockProps) {
  const { theme, heading = "Industry-specific FAQ", subheading = "Everything you need to know", items = DEFAULT_ITEMS } = props;
