...
export default function Faq189(props: BlockProps) {
  const { theme, heading = "Numbered FAQ with indicators", subheading = "Everything you need to know", items = DEFAULT_ITEMS } = props;
