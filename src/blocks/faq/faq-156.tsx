...
export default function Faq156(props: BlockProps) {
  const { theme, heading = "FAQ with support CTA", subheading = "Got questions? We have answers.", items = DEFAULT_ITEMS } = props;
