...
export default function Faq130(props: BlockProps) {
  const { theme, heading = "Minimal FAQ list", subheading = "Quick answers to common questions", items = DEFAULT_ITEMS } = props;
