...
export default function Faq114(props: BlockProps) {
  const { theme, heading = "FAQ with sidebar navigation", subheading = "Everything you need to know", items = DEFAULT_ITEMS } = props;
