...
export default function NavMega009(props: BlockProps) {
  const { theme, heading = "Mega menu dropdown", subheading = "Mega menu dropdown", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
