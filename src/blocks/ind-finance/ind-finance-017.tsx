...
export default function IndFinance017(props: BlockProps) {
  const { theme, heading = "Finance / Banking section", subheading = "Professional finance / banking solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
