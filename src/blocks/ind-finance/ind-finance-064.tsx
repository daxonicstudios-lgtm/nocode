...
export default function IndFinance064(props: BlockProps) {
  const { theme, heading = "Dark finance / banking section", subheading = "Trusted finance / banking platform", buttonText = "Get Started" } = props;
  return (
