...
export default function AnimTransitions022(props: BlockProps) {
  const { theme, heading = "Page transition", subheading = "Page transition", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
