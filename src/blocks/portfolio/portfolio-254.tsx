...
export default function Portfolio254(props: BlockProps) {
  const { theme, heading = "Latest Projects", subheading = "Delivering results through design and code.", items = DEFAULT_ITEMS } = props;
