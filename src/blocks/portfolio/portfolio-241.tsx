...
export default function Portfolio241(props: BlockProps) {
  const { theme, heading = "Selected Projects", subheading = "See what we've built for our clients.", items = DEFAULT_ITEMS } = props;
