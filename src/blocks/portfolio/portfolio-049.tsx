...
export default function Portfolio049(props: BlockProps) {
  const { theme, heading = "Recent Work", subheading = "Delivering results through design and code.", items = DEFAULT_ITEMS } = props;
