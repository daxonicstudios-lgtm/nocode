...
export default function Portfolio270(props: BlockProps) {
  const { theme, heading = "Our Work", subheading = "A showcase of our best work across industries.", items = DEFAULT_ITEMS } = props;
