...
export default function Portfolio131(props: BlockProps) {
  const { theme, heading = "Work Highlights", subheading = "See what we've built for our clients.", items = DEFAULT_ITEMS } = props;
