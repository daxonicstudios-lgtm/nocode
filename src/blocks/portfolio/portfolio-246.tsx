...
export default function Portfolio246(props: BlockProps) {
  const { theme, heading = "What We've Built", subheading = "See what we've built for our clients.", items = DEFAULT_ITEMS } = props;
