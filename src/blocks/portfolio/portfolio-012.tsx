...
export default function Portfolio012(props: BlockProps) {
  const { theme, heading = "Design Portfolio", subheading = "Browse our latest projects and case studies.", items = DEFAULT_ITEMS } = props;
