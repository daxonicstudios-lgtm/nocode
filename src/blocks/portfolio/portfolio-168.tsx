...
export default function Portfolio168(props: BlockProps) {
  const { theme, heading = "Case Studies", subheading = "Explore our creative portfolio.", items = DEFAULT_ITEMS } = props;
