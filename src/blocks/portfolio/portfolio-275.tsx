...
export default function Portfolio275(props: BlockProps) {
  const { theme, heading = "Featured Projects", subheading = "A showcase of our best work across industries.", items = DEFAULT_ITEMS } = props;
