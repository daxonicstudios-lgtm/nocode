...
export default function Portfolio295(props: BlockProps) {
  const { theme, heading = "Client Projects", subheading = "A showcase of our best work across industries.", items = DEFAULT_ITEMS } = props;
