...
export default function Portfolio127(props: BlockProps) {
  const { theme, heading = "Creative Showcase", subheading = "Browse our latest projects and case studies.", items = DEFAULT_ITEMS } = props;
