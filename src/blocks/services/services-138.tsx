...
export default function Services138(props: BlockProps) {
  const { theme, heading = "How We Help", subheading = "Professional solutions tailored to your needs.", items = DEFAULT_ITEMS } = props;
