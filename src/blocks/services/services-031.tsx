...
export default function Services031(props: BlockProps) {
  const { theme, heading = "Capabilities", subheading = "End-to-end services for modern businesses.", items = DEFAULT_ITEMS } = props;
