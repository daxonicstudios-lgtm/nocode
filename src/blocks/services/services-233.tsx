...
export default function Services233(props: BlockProps) {
  const { theme, heading = "What We Offer", subheading = "We bring your vision to life.", items = DEFAULT_ITEMS } = props;
