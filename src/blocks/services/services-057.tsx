...
export default function Services057(props: BlockProps) {
  const { theme, heading = "What We Offer", subheading = "Professional solutions tailored to your needs.", items = DEFAULT_ITEMS } = props;
