...
export default function Services023(props: BlockProps) {
  const { theme, heading = "Capabilities", subheading = "We bring your vision to life.", items = DEFAULT_ITEMS } = props;
