...
export default function Services235(props: BlockProps) {
  const { theme, heading = "Services", subheading = "End-to-end services for modern businesses.", items = DEFAULT_ITEMS } = props;
