...
export default function Services274(props: BlockProps) {
  const { theme, heading = "How We Help", subheading = "End-to-end services for modern businesses.", items = DEFAULT_ITEMS } = props;
