...
export default function Services265(props: BlockProps) {
  const { theme, heading = "What We Offer", subheading = "End-to-end services for modern businesses.", items = DEFAULT_ITEMS } = props;
