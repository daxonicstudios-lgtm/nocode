...
export default function Services045(props: BlockProps) {
  const { theme, heading = "What We Do", subheading = "Professional solutions tailored to your needs.", items = DEFAULT_ITEMS } = props;
