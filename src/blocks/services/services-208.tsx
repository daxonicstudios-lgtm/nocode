...
export default function Services208(props: BlockProps) {
  const { theme, heading = "Our Services", subheading = "End-to-end services for modern businesses.", items = DEFAULT_ITEMS } = props;
