...
export default function Services292(props: BlockProps) {
  const { theme, heading = "Solutions", subheading = "End-to-end services for modern businesses.", items = DEFAULT_ITEMS } = props;
