...
export default function Services051(props: BlockProps) {
  const { theme, heading = "Services", subheading = "Professional solutions tailored to your needs.", items = DEFAULT_ITEMS } = props;
