...
export default function Services228(props: BlockProps) {
  const { theme, heading = "Solutions", subheading = "Professional solutions tailored to your needs.", items = DEFAULT_ITEMS } = props;
