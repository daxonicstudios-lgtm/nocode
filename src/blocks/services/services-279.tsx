...
export default function Services279(props: BlockProps) {
  const { theme, heading = "Capabilities", subheading = "Professional solutions tailored to your needs.", items = DEFAULT_ITEMS } = props;
