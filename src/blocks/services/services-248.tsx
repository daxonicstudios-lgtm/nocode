...
export default function Services248(props: BlockProps) {
  const { theme, heading = "Our Services", subheading = "We bring your vision to life.", items = DEFAULT_ITEMS } = props;
