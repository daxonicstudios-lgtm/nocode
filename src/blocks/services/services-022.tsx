...
export default function Services022(props: BlockProps) {
  const { theme, heading = "Expertise", subheading = "End-to-end services for modern businesses.", items = DEFAULT_ITEMS } = props;
