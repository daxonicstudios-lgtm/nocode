...
export default function Services240(props: BlockProps) {
  const { theme, heading = "Our Services", subheading = "Professional solutions tailored to your needs.", items = DEFAULT_ITEMS } = props;
