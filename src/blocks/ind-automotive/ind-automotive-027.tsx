...
export default function IndAutomotive027(props: BlockProps) {
  const { theme, heading = "Automotive section", subheading = "Professional automotive solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
