...
export default function IndAutomotive053(props: BlockProps) {
  const { theme, heading = "Dark automotive section", subheading = "Trusted automotive platform", buttonText = "Get Started" } = props;
  return (
