...
export default function IndConstruction060(props: BlockProps) {
  const { theme, heading = "Dark construction section", subheading = "Trusted construction platform", buttonText = "Get Started" } = props;
  return (
