...
export default function IndConstruction019(props: BlockProps) {
  const { theme, heading = "Construction section", subheading = "Professional construction solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
