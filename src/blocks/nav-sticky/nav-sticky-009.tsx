...
export default function NavSticky009(props: BlockProps) {
  const { theme, heading = "Sticky header", subheading = "Sticky header", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
