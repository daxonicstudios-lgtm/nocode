...
export default function IndLegal038(props: BlockProps) {
  const { theme, heading = "Legal section", subheading = "Professional legal solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
