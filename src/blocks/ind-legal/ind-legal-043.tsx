...
export default function IndLegal043(props: BlockProps) {
  const { theme, heading = "Dark legal section", subheading = "Trusted legal platform", buttonText = "Get Started" } = props;
  return (
