...
export default function AnimCursor011(props: BlockProps) {
  const { theme, heading = "Cursor effect", subheading = "Cursor effect", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
