...
export default function About004(props: BlockProps) {
  const { theme, heading = "Behind the Scenes", subheading = "Learn more about our mission.", items = DEFAULT_ITEMS } = props;
