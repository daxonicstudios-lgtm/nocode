...
export default function About109(props: BlockProps) {
  const { theme, heading = "What Drives Us", subheading = "The story behind our platform.", items = DEFAULT_ITEMS } = props;
