...
export default function About023(props: BlockProps) {
  const { theme, heading = "What We Do", bodyText = "We are passionate about making technology work for people, not the other way around. Our team of creators and engineers is dedicated to building tools that simplify the complex world of web development." } = props;
