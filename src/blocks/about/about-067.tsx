...
export default function About067(props: BlockProps) {
  const { theme, heading = "Our Journey", subheading = "A team dedicated to your success.", items = DEFAULT_ITEMS } = props;
