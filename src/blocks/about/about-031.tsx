...
export default function About031(props: BlockProps) {
  const { theme, heading = "Our Story", bodyText = "We are a team of designers, engineers, and dreamers building the future of web creation. Our platform empowers anyone to build a professional website in minutes.", items = DEFAULT_ITEMS } = props;
