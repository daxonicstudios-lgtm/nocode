...
export default function About254(props: BlockProps) {
  const { theme, heading = "Behind the Scenes", subheading = "Building the future of web design.", items = DEFAULT_ITEMS } = props;
