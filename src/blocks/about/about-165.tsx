...
export default function About165(props: BlockProps) {
  const { theme, heading = "Meet Our Company", subheading = "The story behind our platform.", bodyText = "Founded in 2024, we set out to make web design accessible to everyone. Today, our platform serves thousands of creators across Africa and beyond, helping them build professional websites without writing a single line of code.", imageUrl } = props;
