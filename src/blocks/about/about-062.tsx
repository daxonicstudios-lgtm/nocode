...
export default function About062(props: BlockProps) {
  const { theme, heading = "Who We Are", subheading = "Building the future of web design.", items = DEFAULT_ITEMS } = props;
