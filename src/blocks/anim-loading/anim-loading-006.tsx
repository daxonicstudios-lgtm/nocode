...
export default function AnimLoading006(props: BlockProps) {
  const { theme, heading = "Loading animation", subheading = "Loading animation", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
