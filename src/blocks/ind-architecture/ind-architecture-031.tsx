...
export default function IndArchitecture031(props: BlockProps) {
  const { theme, heading = "Dark architecture section", subheading = "Trusted architecture platform", buttonText = "Get Started" } = props;
  return (
