...
export default function IndArchitecture018(props: BlockProps) {
  const { theme, heading = "Architecture section", subheading = "Professional architecture solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
