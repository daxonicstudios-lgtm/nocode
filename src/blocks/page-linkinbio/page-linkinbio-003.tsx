...
export default function PageLinkinbio003(props: BlockProps) {
  const { theme, heading = "Link in bio page", subheading = "Link in bio page", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
