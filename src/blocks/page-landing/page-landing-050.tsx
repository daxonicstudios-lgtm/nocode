...
export default function PageLanding050(props: BlockProps) {
  const { theme, heading = "Landing page section", subheading = "Landing page section", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
