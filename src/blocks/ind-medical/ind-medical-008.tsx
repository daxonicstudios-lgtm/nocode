...
export default function IndMedical008(props: BlockProps) {
  const { theme, heading = "Medical / Healthcare section", subheading = "Professional medical / healthcare solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
