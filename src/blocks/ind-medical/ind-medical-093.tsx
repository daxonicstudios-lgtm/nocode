...
export default function IndMedical093(props: BlockProps) {
  const { theme, heading = "Dark medical / healthcare section", subheading = "Trusted medical / healthcare platform", buttonText = "Get Started" } = props;
  return (
