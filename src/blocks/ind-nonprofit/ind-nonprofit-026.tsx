...
export default function IndNonprofit026(props: BlockProps) {
  const { theme, heading = "Non-Profit section", subheading = "Professional non-profit solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
