...
export default function IndNonprofit049(props: BlockProps) {
  const { theme, heading = "Dark non-profit section", subheading = "Trusted non-profit platform", buttonText = "Get Started" } = props;
  return (
