...
export default function IndAgriculture036(props: BlockProps) {
  const { theme, heading = "Dark agriculture section", subheading = "Trusted agriculture platform", buttonText = "Get Started" } = props;
  return (
