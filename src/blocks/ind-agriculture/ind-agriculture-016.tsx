...
export default function IndAgriculture016(props: BlockProps) {
  const { theme, heading = "Agriculture section", subheading = "Professional agriculture solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
