...
export default function PageComing007(props: BlockProps) {
  const { theme, heading = "Coming soon page", subheading = "Coming soon page", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
