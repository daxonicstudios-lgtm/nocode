...
export default function Comparison130(props: BlockProps) {
  const { theme, heading = "Compare Solutions", subheading = "The clear choice for modern teams.", items = DEFAULT_ITEMS } = props;
