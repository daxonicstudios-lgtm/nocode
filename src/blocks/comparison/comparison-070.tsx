...
export default function Comparison070(props: BlockProps) {
  const { theme, heading = "Feature Comparison", subheading = "The clear choice for modern teams.", items = DEFAULT_ITEMS } = props;
