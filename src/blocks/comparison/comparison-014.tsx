...
export default function Comparison014(props: BlockProps) {
  const { theme, heading = "Feature Comparison", subheading = "Features that set us apart.", items = DEFAULT_ITEMS } = props;
