...
export default function Comparison147(props: BlockProps) {
  const { theme, heading = "Us vs. The Rest", subheading = "See how we compare to the competition.", items = DEFAULT_ITEMS } = props;
