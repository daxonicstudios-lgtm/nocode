...
export default function Comparison148(props: BlockProps) {
  const { theme, heading = "See How We Stack Up", subheading = "The clear choice for modern teams.", items = DEFAULT_ITEMS } = props;
