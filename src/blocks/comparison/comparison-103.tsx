...
export default function Comparison103(props: BlockProps) {
  const { theme, heading = "Before & After", subheading = "The clear choice for modern teams.", items = DEFAULT_ITEMS } = props;
