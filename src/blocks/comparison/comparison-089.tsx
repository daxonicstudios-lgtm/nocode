...
export default function Comparison089(props: BlockProps) {
  const { theme, heading = "The Difference", subheading = "Features that set us apart.", items = DEFAULT_ITEMS } = props;
