...
export default function Comparison008(props: BlockProps) {
  const { theme, heading = "Why Choose Us", subheading = "Features that set us apart.", items = DEFAULT_ITEMS } = props;
