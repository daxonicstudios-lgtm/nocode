...
export default function Comparison043(props: BlockProps) {
  const { theme, heading = "Us vs. The Rest", subheading = "The clear choice for modern teams.", items = DEFAULT_ITEMS } = props;
