...
export default function Comparison141(props: BlockProps) {
  const { theme, heading = "Side by Side", subheading = "See how we compare to the competition.", items = DEFAULT_ITEMS } = props;
