...
export default function Comparison009(props: BlockProps) {
  const { theme, heading = "The Difference", subheading = "See how we compare to the competition.", items = DEFAULT_ITEMS } = props;
