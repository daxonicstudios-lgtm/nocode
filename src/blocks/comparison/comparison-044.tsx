...
export default function Comparison044(props: BlockProps) {
  const { theme, heading = "See How We Stack Up", subheading = "Features that set us apart.", items = DEFAULT_ITEMS } = props;
