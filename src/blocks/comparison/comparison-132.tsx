...
export default function Comparison132(props: BlockProps) {
  const { theme, heading = "See How We Stack Up", subheading = "See how we compare to the competition.", items = DEFAULT_ITEMS } = props;
