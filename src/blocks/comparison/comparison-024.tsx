...
export default function Comparison024(props: BlockProps) {
  const { theme, heading = "Why Choose Us", subheading = "See how we compare to the competition.", items = DEFAULT_ITEMS } = props;
