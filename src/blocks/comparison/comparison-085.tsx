...
export default function Comparison085(props: BlockProps) {
  const { theme, heading = "Side by Side", subheading = "The clear choice for modern teams.", items = DEFAULT_ITEMS } = props;
