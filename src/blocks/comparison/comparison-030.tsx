...
export default function Comparison030(props: BlockProps) {
  const { theme, heading = "Feature Comparison", subheading = "See how we compare to the competition.", items = DEFAULT_ITEMS } = props;
