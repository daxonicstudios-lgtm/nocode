...
export default function Comparison135(props: BlockProps) {
  const { theme, heading = "Before & After", subheading = "See how we compare to the competition.", items = DEFAULT_ITEMS } = props;
