...
export default function Comparison146(props: BlockProps) {
  const { theme, heading = "Compare Solutions", subheading = "Features that set us apart.", items = DEFAULT_ITEMS } = props;
