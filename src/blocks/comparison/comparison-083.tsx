...
export default function Comparison083(props: BlockProps) {
  const { theme, heading = "Us vs. The Rest", subheading = "Features that set us apart.", items = DEFAULT_ITEMS } = props;
