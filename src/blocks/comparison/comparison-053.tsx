...
export default function Comparison053(props: BlockProps) {
  const { theme, heading = "Side by Side", subheading = "Features that set us apart.", items = DEFAULT_ITEMS } = props;
