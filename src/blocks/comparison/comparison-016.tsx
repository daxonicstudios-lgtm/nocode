...
export default function Comparison016(props: BlockProps) {
  const { theme, heading = "Why Choose Us", subheading = "The clear choice for modern teams.", items = DEFAULT_ITEMS } = props;
