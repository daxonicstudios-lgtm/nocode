...
export default function Page404022(props: BlockProps) {
  const { theme, heading = "404 error page", subheading = "404 error page", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
