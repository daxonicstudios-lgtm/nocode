...
export default function FormPayment050(props: BlockProps) {
  const { theme, heading = "Payment / donation form", subheading = "Payment / donation form", buttonText = "Submit" } = props;
