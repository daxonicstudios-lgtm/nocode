...
export default function Navbar496(props: BlockProps) {
  const {
    theme,
    heading = "Jane Doe",
    logoUrl,
        ...
        <div className="flex h-16 items-center justify-between">
          <a href="#" className="flex items-center gap-2.5">
            {logoUrl ? <img src={logoUrl} alt={heading} className="h-8 w-auto" /> : (
              <>
                <span className="flex h-8 w-8 items-center justify-center rounded-lg text-sm font-black text-white" style={{ backgroundColor: theme?.primary || "#111827" }}>J</span>
