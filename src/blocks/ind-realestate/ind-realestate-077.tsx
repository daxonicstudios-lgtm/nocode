...
export default function IndRealestate077(props: BlockProps) {
  const { theme, heading = "Dark real estate section", subheading = "Trusted real estate platform", buttonText = "Get Started" } = props;
  return (
