...
export default function IndRealestate011(props: BlockProps) {
  const { theme, heading = "Real Estate section", subheading = "Professional real estate solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
