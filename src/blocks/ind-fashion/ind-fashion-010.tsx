...
export default function IndFashion010(props: BlockProps) {
  const { theme, heading = "Fashion section", subheading = "Professional fashion solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
