...
export default function IndFashion042(props: BlockProps) {
  const { theme, heading = "Dark fashion section", subheading = "Trusted fashion platform", buttonText = "Get Started" } = props;
  return (
