...
export default function IndTravel004(props: BlockProps) {
  const { theme, heading = "Travel / Tourism section", subheading = "Professional travel / tourism solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
