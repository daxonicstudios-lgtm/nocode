...
export default function IndTravel056(props: BlockProps) {
  const { theme, heading = "Dark travel / tourism section", subheading = "Trusted travel / tourism platform", buttonText = "Get Started" } = props;
  return (
