...
export default function PagePassword004(props: BlockProps) {
  const { theme, heading = "Password protected page", subheading = "Password protected page", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
