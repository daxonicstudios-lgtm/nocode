...
export default function FormSurvey067(props: BlockProps) {
  const { theme, heading = "Dark survey or quiz form", subheading = "Survey or quiz form", buttonText = "Submit" } = props;
