...
export default function IndLogistics021(props: BlockProps) {
  const { theme, heading = "Dark logistics / shipping section", subheading = "Trusted logistics / shipping platform", buttonText = "Get Started" } = props;
  return (
