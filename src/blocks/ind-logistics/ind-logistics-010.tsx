...
export default function IndLogistics010(props: BlockProps) {
  const { theme, heading = "Logistics / Shipping section", subheading = "Professional logistics / shipping solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
