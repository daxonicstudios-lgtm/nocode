...
export default function Video049(props: BlockProps) {
  const { theme, heading = "See It in Action", subheading = "See our platform in action.", bodyText = "Watch our quick overview to see how easy it is to build your website.", buttonText = "Watch Now", imageUrl } = props;
