...
export default function Video060(props: BlockProps) {
  const { theme, heading = "Video Walkthrough", subheading = "A quick tour of everything you can do.", imageUrl } = props;
