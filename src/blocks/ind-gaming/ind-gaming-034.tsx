...
export default function IndGaming034(props: BlockProps) {
  const { theme, heading = "Dark gaming section", subheading = "Trusted gaming platform", buttonText = "Get Started" } = props;
  return (
