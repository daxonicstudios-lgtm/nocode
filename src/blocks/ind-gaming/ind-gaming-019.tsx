...
export default function IndGaming019(props: BlockProps) {
  const { theme, heading = "Gaming section", subheading = "Professional gaming solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
