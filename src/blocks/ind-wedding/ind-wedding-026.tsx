...
export default function IndWedding026(props: BlockProps) {
  const { theme, heading = "Wedding section", subheading = "Professional wedding solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
