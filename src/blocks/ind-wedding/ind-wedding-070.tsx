...
export default function IndWedding070(props: BlockProps) {
  const { theme, heading = "Dark wedding section", subheading = "Trusted wedding platform", buttonText = "Get Started" } = props;
  return (
