...
export default function Steps192(props: BlockProps) {
  const { theme, heading = "The Workflow", subheading = "Follow these steps to get started.", items = DEFAULT_ITEMS } = props;
