...
export default function Steps161(props: BlockProps) {
  const { theme, heading = "Quick Start Guide", subheading = "A simple process designed for everyone.", items = DEFAULT_ITEMS } = props;
