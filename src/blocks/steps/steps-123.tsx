...
export default function Steps123(props: BlockProps) {
  const { theme, heading = "Simple Steps", subheading = "We make it easy to build something great.", items = DEFAULT_ITEMS } = props;
