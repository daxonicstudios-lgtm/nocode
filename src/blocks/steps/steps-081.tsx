...
export default function Steps081(props: BlockProps) {
  const { theme, heading = "The Process", subheading = "A simple process designed for everyone.", items = DEFAULT_ITEMS } = props;
