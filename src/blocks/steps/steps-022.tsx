...
export default function Steps022(props: BlockProps) {
  const { theme, heading = "How to Begin", subheading = "Follow these steps to get started.", items = DEFAULT_ITEMS } = props;
