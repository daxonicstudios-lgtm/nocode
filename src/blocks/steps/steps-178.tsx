...
export default function Steps178(props: BlockProps) {
  const { theme, heading = "Your Path Forward", subheading = "We make it easy to build something great.", items = DEFAULT_ITEMS } = props;
