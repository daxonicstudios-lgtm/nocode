...
export default function Steps179(props: BlockProps) {
  const { theme, heading = "Build in 3 Steps", subheading = "No technical skills required.", items = DEFAULT_ITEMS } = props;
