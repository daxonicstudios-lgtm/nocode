...
export default function Team065(props: BlockProps) {
  const { theme, heading = "Team cards with details", subheading = "Talented people building great things", items = DEFAULT_ITEMS } = props;
  return (
