...
export default function FormSignup004(props: BlockProps) {
  const { theme, heading = "Signup / registration form", subheading = "Signup / registration form", buttonText = "Submit" } = props;
