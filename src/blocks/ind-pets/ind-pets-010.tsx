...
export default function IndPets010(props: BlockProps) {
  const { theme, heading = "Pets / Veterinary section", subheading = "Professional pets / veterinary solutions", buttonText = "Learn More", buttonUrl = "#" } = props;
  return (
