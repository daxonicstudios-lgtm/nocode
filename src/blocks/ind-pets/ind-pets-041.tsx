...
export default function IndPets041(props: BlockProps) {
  const { theme, heading = "Dark pets / veterinary section", subheading = "Trusted pets / veterinary platform", buttonText = "Get Started" } = props;
  return (
