...
export default function NavBacktotop013(props: BlockProps) {
  const { theme, heading = "Back to top button", subheading = "Back to top button", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
