...
export default function Content178(props: BlockProps) {
  const { theme, heading = "Why We Exist", bodyText = "We started with a simple question: why is building a website still so hard? After years of research, we built a platform that anyone can use — no coding, no design skills, no hassle." } = props;
