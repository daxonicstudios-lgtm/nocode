...
export default function NavPagination001(props: BlockProps) {
  const { theme, heading = "Pagination controls", subheading = "Pagination controls", buttonText = "Get Started", buttonUrl = "#" } = props;
  return (
